...
(* C type definitions for the OO-style tests. *)
...
let () = Cstubs.register_paths animal_methods
  ~value:"Types.animal_methods" ~typ:"Types.animal_methods"
let () = Cstubs.register_paths animal
  ~value:"Types.animal" ~typ:"Types.animal"
...
let () = Cstubs.register_paths camel_methods
  ~value:"Types.camel_methods" ~typ:"Types.camel_methods"
let () = Cstubs.register_paths camel
  ~value:"Types.camel" ~typ:"Types.camel"
