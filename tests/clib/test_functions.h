...
void add_complexd(doublecomplex_t *, doublecomplex_t *, doublecomplex_t *);
void mul_complexd(doublecomplex_t *, doublecomplex_t *, doublecomplex_t *);
void rotdist_complexd(doublecomplex_t *, double *, double *);
void add_complexld(longdoublecomplex_t *, longdoublecomplex_t *, longdoublecomplex_t *);
void mul_complexld(longdoublecomplex_t *, longdoublecomplex_t *, longdoublecomplex_t *);
void rotdist_complexld(longdoublecomplex_t *, long double *, long double *);
void add_complexf(floatcomplex_t *, floatcomplex_t *, floatcomplex_t *);
void mul_complexf(floatcomplex_t *, floatcomplex_t *, floatcomplex_t *);
void rotdist_complexf(floatcomplex_t *, float *, float *);
doublecomplex_t add_complexd_val(doublecomplex_t, doublecomplex_t);
doublecomplex_t mul_complexd_val(doublecomplex_t, doublecomplex_t);
double rotdist_complexd_val(doublecomplex_t, double);
longdoublecomplex_t add_complexld_val(longdoublecomplex_t, longdoublecomplex_t);
longdoublecomplex_t mul_complexld_val(longdoublecomplex_t, longdoublecomplex_t);
long double rotdist_complexld_val(longdoublecomplex_t, long double);
floatcomplex_t add_complexf_val(floatcomplex_t, floatcomplex_t);
floatcomplex_t mul_complexf_val(floatcomplex_t, floatcomplex_t);
float rotdist_complexf_val(floatcomplex_t, float);
