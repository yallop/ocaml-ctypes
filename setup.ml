...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5999a1762aaa35c7a64c2b74d3485cf4) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_raw", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_pointers",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_pointers", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_higher_order",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_higher_order", []))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_structs",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_structs", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_finalisers",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_finalisers", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_cstdlib",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_cstdlib", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_sizeof",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_sizeof", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_stubs",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_stubs", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_arrays",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_arrays", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_unions",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_unions", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_custom_ops",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_custom_ops", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_ctypes_errno",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_errno", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_passable",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_passable", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_alignment",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_alignment", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_views",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_views", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_foreign_values",
          ...
          ("test_oo_style",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_oo_style", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ("test_type_printing",
          ...
          ("test_complex",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_complex", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 });
          ...
          ("test_bigarrays",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ctypes_bigarrays", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     doc = [("ctypes", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("ctypes", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("test_ctypes_raw",
                      ...
                      Some
                        (("ocamlc",
                           [
                              "-custom";
                              "primitive_details.c";
                              "primitive_details.ml";
                              "-o";
                              "primitive_details";
                              "&&";
                              "./primitive_details";
                              "src/ctypes_primitives.ml"
                           ])))
                 ];
            ...
            [
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             ["-fPIC"; "-Wall"; "-Wno-unused-variable"; "-O3"
                             ])
                        ];
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "ctypes";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "ctypes-foreign";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ctypes"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["dl_stubs.c"; "ffi_type_stubs.c"; "ffi_call_stubs.c"
                        ];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                   ...
                   {
                      lib_modules = ["Dl"; "Foreign"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Closure_properties"; "WeakRef"; "Ffi_stubs"; "Ffi"];
                      lib_findlib_parent = Some "ctypes";
                      lib_findlib_name = Some "foreign";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "examples/fts";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ctypes-foreign"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lncurses"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ctypes_printers"; "Install_printers"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ctypes";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ncurses";
                           InternalLibrary "ctypes-foreign"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "ncurses_cmd.ml"; });
               Executable
                 ({
                     cs_name = "fts_cmd";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "examples/fts";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "fts"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "fts_cmd.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_raw";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_raw.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_pointers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_pointers.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_higher_order";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_higher_order.ml";
                      });
               Executable
                 ({
                     cs_name = "test_ctypes_structs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_structs.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_finalisers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_finalisers.ml"; 
                   });
               Executable
                 ({
                     cs_name = "test_ctypes_cstdlib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_cstdlib.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_sizeof";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_sizeof.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_unions";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_unions.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_custom_ops";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_custom_ops.ml"; 
                   });
               Executable
                 ({
                     cs_name = "test_ctypes_arrays";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_array.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_errno";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_errno.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_passable";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_passable.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_alignment";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_alignment.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_views";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_views.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_global_values";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_foreign_values.ml";
                      });
               Executable
                 ({
                     cs_name = "test_ctypes_oo_style";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_oo_style.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_type_printing";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_type_printing.ml";
                      });
               Executable
                 ({
                     cs_name = "test_ctypes_value_printing";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_value_printing.ml";
                      });
               Executable
                 ({
                     cs_name = "test_ctypes_complex";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_complex.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_callback_lifetime";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_callback_lifetime.ml";
                      });
               Executable
                 ({
                     cs_name = "test_stubs";
                   ...
                   {exec_custom = true; exec_main_is = "test_stubs.ml"; });
               Executable
                 ({
                     cs_name = "test_ctypes_bigarrays";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "test_bigarrays.ml"; });
               Executable
                 ({
                     cs_name = "date_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "date.ml"; });
               Test
                 ({
                     cs_name = "test_ctypes_raw";
                     cs_data = PropList.Data.create ();
               ...
               Test
                 ({
                     cs_name = "test_callback_lifetime";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "o\205a6S\139%\249\128(\163\229\228\229\205\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
