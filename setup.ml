...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ae087ee0937cc731f3710bc4357014c) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Unsigned"; "Signed"; "Ctypes"; "PosixTypes"];
                      lib_pack = false;
                      lib_internal_modules = ["Ctypes_raw"; "WeakRef"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\223\217!\154\181,IgF\186\143t\207\006L\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
