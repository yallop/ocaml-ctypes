...
(* OASIS_START *)
(* DO NOT EDIT (digest: cf33dd812fb7512eb7b8b28b57cfc51e) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [FindlibPackage ("unix", None); InternalLibrary "fts"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\254\228\207\176$0q\202\210\022%9\201\2201B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
