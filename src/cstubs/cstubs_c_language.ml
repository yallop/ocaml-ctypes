...
let prim_prj : type a. a Ctypes_primitive_types.prim -> _ =
  ...
  | Uchar -> reader "Int_val" (value @-> returning uint8_t)
  ...
  | Uint8_t -> reader "Int_val" (value @-> returning uint8_t)
  | Uint16_t -> reader "Int_val" (value @-> returning uint16_t)
...
let prim_inj : type a. a Ctypes_primitive_types.prim -> _ =
  ...
  | Uchar -> immediater "Val_int" (uint8_t @-> returning value)
  ...
  | Uint8_t -> immediater "Val_int" (uint8_t @-> returning value)
  | Uint16_t -> immediater "Val_int" (uint16_t @-> returning value)
