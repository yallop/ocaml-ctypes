...
let prim_inj : type a. a Ctypes_primitive_types.prim -> _ =
  ...
  | Uchar -> immediater "Ctypes_val_uint8" (uint8_t @-> returning value)
  ...
  | Uint8_t -> immediater "Ctypes_val_uint8" (uint8_t @-> returning value)
  | Uint16_t -> immediater "Ctypes_val_uint16" (uint16_t @-> returning value)
