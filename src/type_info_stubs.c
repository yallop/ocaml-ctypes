...
make_primitive_interface(caml_copy_double, Double_val, double, double, ffi_type_double, "%f")
make_primitive_interface(caml_copy_double, Double_val, float, float, ffi_type_float, "%f")
